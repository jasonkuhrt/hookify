...
| [`plugins/hookify-claude`](plugins/hookify-claude/.claude-plugin/plugin.json) | Claude-facing plugin wrapper with plugin-level hooks and shared Hookify skills                                                                      |
...
| [`packages/cli`](packages/cli/src/bin.ts)                                     | Publishable `hookify` entrypoint for `npx hookify install codex`                                                                                    |
